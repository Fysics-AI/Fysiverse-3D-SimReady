...
def export_manifest(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if gravity_source.is_file():
        ...
        stage_entries.append({**GRAVITY_STAGE, "source_blend": str(gravity_source), "blend": GRAVITY_STAGE["blend"], "kind": "animated"})
    else:
